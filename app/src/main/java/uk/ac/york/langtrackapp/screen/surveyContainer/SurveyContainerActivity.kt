...
import uk.ac.york.langtrackapp.databinding.SurveyContainerActivityBinding
import uk.ac.york.langtrackapp.interfaces.*
import uk.ac.york.langtrackapp.popup.OneChoicePopup
import uk.ac.york.langtrackapp.popup.PopupAlert
import uk.ac.york.langtrackapp.screen.surveyContainer.fillInTheBlankFragment.FillInTheBlankFragment
import uk.ac.york.langtrackapp.screen.surveyContainer.footerFragment.FooterFragment
import uk.ac.york.langtrackapp.screen.surveyContainer.header.HeaderFragment
import uk.ac.york.langtrackapp.screen.surveyContainer.likertScaleFragment.LikertScaleFragment
import uk.ac.york.langtrackapp.screen.surveyContainer.multipleChoiceFragment.MultipleChoiceFragment
import uk.ac.york.langtrackapp.screen.surveyContainer.openEndedTextResponsesFragment.OpenEndedTextResponsesFragment
import uk.ac.york.langtrackapp.screen.surveyContainer.singleMultipleAnswersFragment.SingleMultipleAnswersFragment
import uk.ac.york.langtrackapp.screen.surveyContainer.sliderScale.SliderScaleFragment
import uk.ac.york.langtrackapp.screen.surveyContainer.timeDuration.TimeDurationFragment
import uk.ac.york.langtrackapp.util.formatToReadable
import uk.ac.york.langtrackapp.util.loadFragment
