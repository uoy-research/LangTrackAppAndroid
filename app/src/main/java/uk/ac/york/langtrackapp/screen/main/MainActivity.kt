...
import uk.ac.york.langtrackapp.screen.about.AboutActivity
import uk.ac.york.langtrackapp.screen.contact.ContactActivity
import uk.ac.york.langtrackapp.screen.instructions.InstructionsActivity
import uk.ac.york.langtrackapp.screen.login.LoginActivity
import uk.ac.york.langtrackapp.screen.overview.OverviewActivity
import uk.ac.york.langtrackapp.screen.surveyContainer.SurveyContainerActivity
import uk.ac.york.langtrackapp.util.MyFirebaseInstanceIDService
import uk.ac.york.langtrackapp.util.getVersionNumber
